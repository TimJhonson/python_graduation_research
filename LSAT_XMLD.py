...
##### LSAT
LSATdata = pd.read_csv('C:/Users/Tim/Desktop/SUM/201230_001_STO#2020-10-26-(25)-No1_CoL23_T33K_01.dat',encoding='utf-8',delimiter="\t" )
LSATdata = LSATdata[2690:8650]

LSATxmld = LSATdata["LH"]+2*LSATdata["LV"] 
LSAT_experiment = LSATdata["LH"] - LSATdata["LV"] -0.14
LSATdata["Energy(eV)"] = LSATdata["Energy(eV)"] - 783.7
...
plt.plot(LSATdata["Energy(eV)"],LSATdata["LV"],label='experiment LV',color='b')
plt.plot(LSATdata["Energy(eV)"],LSATdata["LH"],label='experiment LH',color='r')
...
plt.plot(LSATdata["Energy(eV)"],LSAT_experiment,label='experiment of LH-LV',color='black')
...
plt.title( 'LSAT XMLD 76%LS+24%HS'  )
plt.savefig('LSAT_xmld.png')
plt.show()