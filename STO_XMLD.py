...
### STO
STOdata = pd.read_csv('C:/Users/Tim/Desktop/fixed/201230_001_STO#2020-10-26-(25)-No1_CoL23_T33K_01.dat',encoding='utf-8',delimiter="\t" )
...
plt.title( 'STO XMLD 76%LS+24%HS'  )
plt.savefig('STO_xmld.png')
plt.show()
