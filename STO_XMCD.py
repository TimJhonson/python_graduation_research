...
LS = pd.read_csv('C:/Users/Tim/Desktop/理論數據/Theory/LS/Co_210324_005_LS_726' + '_XMCD' +'_XAS.dat', sep="\s+",    encoding='utf-8',skiprows=6,engine='python',header=None ) 

              
HS = pd.read_csv('C:/Users/Tim/Desktop/理論數據/Theory/HS/Co_210325_004_HS_726_XMCD_XAS.dat', sep="\s+",    encoding='utf-8',skiprows=6,engine='python',header=None ) 
...
plt.title( 'STO XMCD 76%LS+24%HS'  )
plt.savefig('STO_xmcd.png')
plt.show()